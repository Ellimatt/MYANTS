  ...
  public initStuff() {
    ...
    this.evolution = new Research(
      ...
      () => {
        ...
        this.game.world.experience = this.game.world.experience.times(1E90000000000);
      }
    );
    ...
    this.escape = new Research(
      ...
      () => {
        this.game.world.toUnlock.forEach(
          t => (t.basePrice = t.basePrice.div(1E90000000))
        );
    ...
    this.adaptation = new Research(
      ...
      () => {
        this.game.world.toUnlock.forEach(
          t => (t.basePrice = t.basePrice.div(1E900000000))
        );
        //   this.game.world.toUnlockMax.forEach(t => t.basePrice = t.basePrice.times(4))
      }
    );
    ...
    this.hereAndNow2 = new Research(
      ...
      this.game,
      () => {
        this.game.world.experience = this.game.world.experience.times(1E900000000);
      }
    );
    ...
    this.hereAndNow = new Research(
      "hereAndNow",
      "Here and Now",
      "Get 10% AI world experience, min 10.",
      [new Cost(this.game.baseWorld.science, new Decimal(10))],
